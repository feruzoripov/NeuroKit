...
def test_HRV_SymDyn_():
    ...
    expected_results = pd.DataFrame(
        ...
        'HRV_SymDyn_EqualPorba6_2LV', 'HRV_SymDyn_EqualPorba6_2UV',
        'HRV_SymDyn_MaxMin6_0V', 'HRV_SymDyn_MaxMin6_1V', 'HRV_SymDyn_MaxMin6_2LV',
        'HRV_SymDyn_MaxMin6_2UV', 'HRV_SymDyn_Sigma05_0V',
        'HRV_SymDyn_Sigma05_1V', 'HRV_SymDyn_Sigma05_2LV',
